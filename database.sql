...
CREATE TABLE `friendrequest` (
  ...
  `target` int NOT NULL,
  `state` char(8) COLLATE utf8_unicode_ci DEFAULT 'Waiting',
  PRIMARY KEY (`requestor`,`target`),
  KEY `fk_target` (`target`),
  CONSTRAINT `fk_requestor` FOREIGN KEY (`requestor`) REFERENCES `persons` (`id`),
  CONSTRAINT `fk_target` FOREIGN KEY (`target`) REFERENCES `persons` (`id`),
  CONSTRAINT `CHK_state` CHECK ((`state` in (_utf8mb4'Waiting',_utf8mb4'Accepted',_utf8mb4'Denied')))
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `friendrequest` VALUES (3,1,'Accepted');
...
CREATE TABLE `friendships` (
  ...
  UNIQUE KEY `unq_friendships_requestor_acceptor` ((least(`requestor`,`acceptor`)),(greatest(`requestor`,`acceptor`))),
  KEY `fk_friendships_requestor` (`requestor`),
  KEY `fk_friendships_acceptor` (`acceptor`),
  CONSTRAINT `fk_friendships_acceptor` FOREIGN KEY (`acceptor`) REFERENCES `persons` (`id`),
  CONSTRAINT `fk_friendships_requestor` FOREIGN KEY (`requestor`) REFERENCES `persons` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `persons` (
  ...
  `fullName` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci GENERATED ALWAYS AS (concat(`firstName`,_utf8mb3' ',`lastName`)) VIRTUAL,
  `email` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `password` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `birthday` date NOT NULL,
  `gender` char(1) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `public` bit(1) DEFAULT (0),
  PRIMARY KEY (`id`),
  UNIQUE KEY `email` (`email`),
  CONSTRAINT `ck_persons_gender` CHECK (((`gender` = _utf8mb3'M') or (`gender` = _utf8mb3'F')))
...
INSERT INTO `persons` (`id`, `firstName`, `lastName`, `email`, `password`, `birthday`, `gender`, `public`) VALUES (1,'João','Fé','jf@sapo.pt','123','2000-10-25','M',_binary '\0'),(3,'Maria','Manuela','mm@gmail.com','123','1905-01-01','F',_binary '\0'),(4,'afonso','gay','af@gmail.com','123','1929-06-01','M',_binary '\0'),(5,'Miguel Angel','Félix Gallardo','mfg@gmail.com','123','1905-01-01','M',_binary ''),(6,'Orlando','Eduardo','orlando@gmail.com','123','1905-01-14','M',_binary '\0');
...
CREATE TABLE `postLikes` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_post_person_postLikes` (`post`,`person`),
  KEY `fk_person_postLikes` (`person`),
  CONSTRAINT `fk_person_postLikes` FOREIGN KEY (`person`) REFERENCES `persons` (`id`),
  CONSTRAINT `fk_post_postLikes` FOREIGN KEY (`post`) REFERENCES `posts` (`id`)
...
INSERT INTO `postlikes` VALUES (1,1),(2,1),(3,1),(4,1),(1,3),(4,4),(1,5);
...
INSERT INTO `posts` VALUES (1,1,'2020-04-13 11:52:12','Bom dia, sou o João'),(2,3,'2020-04-13 11:52:49','Bom dia, sou a Maria'),(3,1,'2020-04-13 20:39:44','Buenas tardes'),(4,1,'2020-04-16 09:22:48','testest'),(5,5,'2020-05-24 11:40:32','OLA OLA OLA'),(6,1,'2020-05-24 15:51:00','as'),(7,1,'2020-05-24 15:53:13','dd'),(8,1,'2020-05-24 15:54:53','poppp\nllll'),(9,1,'2020-05-24 15:55:17','dadaw\n\ndwadw'),(10,1,'2020-05-24 15:55:37','ddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd'),(11,1,'2020-05-24 16:01:04','lll\nçççç'),(12,6,'2020-05-27 10:15:39','Bom dia'),(13,3,'2020-06-03 13:06:56','test em direto');
...
-- Dump completed on 2020-06-08 19:59:47
