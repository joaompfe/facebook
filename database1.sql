...
CREATE TABLE `images` (
  ...
  `author` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fg_image_author` (`author`),
  CONSTRAINT `fg_image_author` FOREIGN KEY (`author`) REFERENCES `persons` (`id`)
...
INSERT INTO `images` VALUES (1,'LogoNovoPolitecnico (2).png',1),(2,'tomate.jpg',1),(3,'wallhaven-g8k25d_1920x1080.png',1),(4,'Anotação 2020-04-09 170114.png',1),(5,'Anotação 2020-04-09 170114.png',1),(6,'wallhaven-vg2y5p_1920x1080.png',1),(7,'Screenshot_9.png',1),(8,'LogoNovoPolitecnico (2).png',1),(9,'69-698893_closed-book-icon-book-icon-png-transparent-png.png',1),(10,'LogoNovoPolitecnico (2).png',1),(11,'LogoNovoPolitecnico (2).png',1),(12,'69-698893_closed-book-icon-book-icon-png-transparent-png.png',1),(13,'69-698893_closed-book-icon-book-icon-png-transparent-png.png',1),(14,'69-698893_closed-book-icon-book-icon-png-transparent-png.png',1),(15,'image.jpg',1),(16,'69-698893_closed-book-icon-book-icon-png-transparent-png.png',1),(17,'182-1826106_pied-piper-wallpaper-1920-x-1080-pied-piper.png',1),(18,'LogoNovoPolitecnico (2).png',1),(19,'LogoNovoPolitecnico (2).png',1),(20,'LogoNovoPolitecnico (2).png',1),(21,'69-698893_closed-book-icon-book-icon-png-transparent-png.png',1),(22,'wallhaven-g8k25d_1920x1080.png',1),(23,'182-1826106_pied-piper-wallpaper-1920-x-1080-pied-piper.png',1),(24,'182-1826106_pied-piper-wallpaper-1920-x-1080-pied-piper.png',1),(25,'182-1826106_pied-piper-wallpaper-1920-x-1080-pied-piper.png',1),(26,'LogoNovoPolitecnico (2).png',1),(27,'69-698893_closed-book-icon-book-icon-png-transparent-png.png',1),(28,'LogoNovoPolitecnico (2).png',1),(29,'69-698893_closed-book-icon-book-icon-png-transparent-png.png',1),(30,'artist_waves_colorful_129158_1920x1080.jpg',1),(31,'artist_waves_colorful_129158_1920x1080.jpg',1),(32,'wallhaven-g8k25d_1920x1080.png',1),(33,'wallhaven-g8k25d_1920x1080.png',1),(34,'wallhaven-g8k25d_1920x1080.png',1),(35,'wallhaven-g8k25d_1920x1080.png',1),(36,'wallhaven-g8k25d_1920x1080.png',1),(37,'wallhaven-g8k25d_1920x1080.png',1),(38,'1_R8Tw7k4Sla3sz7y3WoFc_Q.png',1),(39,'image.jpg',1),(40,'image.jpg',1),(41,'rui.jpg',1),(42,'rui.jpg',1),(43,'image.jpg',1),(44,'image.jpg',1);
...
INSERT INTO `persons` (`id`, `firstName`, `lastName`, `email`, `password`, `birthday`, `gender`, `profilePicID`) VALUES (1,'João','Fé','jf@sapo.pt','123','2000-10-25','M',44),(3,'Maria','Manuela','mm@gmail.com','123','1905-01-01','F',1),(4,'afonso','gay','af@gmail.com','123','1929-06-01','M',NULL),(5,'Miguel Angel','Félix Gallardo','mfg@gmail.com','123','1905-01-01','M',NULL);
...
-- Dump completed on 2020-05-10 14:29:52
